...
namespace DeckBuilder.DAL
{
    ...
    public class DeckBuilderInitializer : DropCreateDatabaseIfModelChanges<DeckBuilderContext>    
    {
        protected override void Seed(DeckBuilderContext context)
        {
            ...
            {
                new Card { Name = "Mana Crystal",   ManaCost = 1, Description="Basic Mana Crystal.", CardArtUrl="/content/images/ManaCrystal.png", CardType = cardTypes.Single(t => t.Name == "Crystal"),  Crystal_Name = "Mana Crystal", Crystal_Url = "/content/images/manacrystal.png", Crystal_Mana=1, Crystal_Range=2 },
