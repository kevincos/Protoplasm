...
namespace DeckBuilder.Models
{
    ...
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipCreateStatus CreateOpenIDUser(string userName, string password, string email, string OpenID)
        {
            if (String.IsNullOrEmpty(userName)) throw new ArgumentException("Value cannot be null or empty.", "userName");
            if (String.IsNullOrEmpty(password)) throw new ArgumentException("Value cannot be null or empty.", "password");
            if (String.IsNullOrEmpty(email)) throw new ArgumentException("Value cannot be null or empty.", "email");
        ...
        public MembershipUser GetOpenIDUser(string OpenID)
        {
            return _provider.GetUser(StringToGUID(OpenID), true);
        }
